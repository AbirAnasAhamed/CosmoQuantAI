...
import { Maximize2, Settings, BarChart2, CandlestickChart, Activity } from 'lucide-react';
             ...
             {['15m', '1H', '4H', '1D', '1W'].map(tf => (
               <button 
                 ...
                 className={`px-3 py-1 text-xs font-medium rounded transition-colors ${
                   timeframe === tf ? 'bg-omni-accent text-omni-bg' : 'text-slate-400 hover:text-white'
                 }`}
               >
                 {tf}
               </button>
