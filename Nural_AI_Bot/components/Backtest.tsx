...
import { Play, Settings, RefreshCw, TrendingUp, TrendingDown, Activity, AlertTriangle, Download } from 'lucide-react';
           ...
           <div className="space-y-4">
              ...
              <button 
                ...
                className={`w-full py-3 rounded-lg font-bold flex items-center justify-center gap-2 mt-4 transition-all ${
                    isRunning ? 'bg-slate-700 text-slate-400' : 'bg-omni-accent hover:bg-blue-400 text-omni-bg'
                }`}
              >
