      ...
      <div className="space-y-6">
        <div className="bg-omni-panel border border-slate-700 rounded-xl p-6 relative overflow-hidden">
          ...
          <button
            ...
            className={`w-full py-4 rounded-xl font-bold text-lg tracking-wide shadow-lg transition-all mb-4 ${
              isAnalyzing 
        ...
        {analysis ? (
          <div className="flex-1 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className={`p-6 rounded-xl border-2 text-center ${
              analysis.decision === 'BUY' ? 'border-omni-success bg-omni-success/10' :
              ...
              <span className={`text-4xl font-black ${
                 analysis.decision === 'BUY' ? 'text-omni-success' :
