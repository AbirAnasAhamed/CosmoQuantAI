    ...
    *,
    ...
    if bot.status == "active":
        try:
            ...
            # 🛑 FAIL-SAFE: Abort deletion if stop/cancel fails
            raise HTTPException(
                status_code=500, 
                detail="Cannot delete bot: Failed to stop safely or cancel orders. Please try stopping it manually first or contact support."
            )
