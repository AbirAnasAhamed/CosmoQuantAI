...
class ForexMLTrainingEngine:
    ...
    def start_training(self):
        ...
        try:
            ...
            data_file = os.path.join(os.getcwd(), "data", "forex", f"{clean_symbol}_data.csv")
            
            if not os.path.exists(data_file):
                raise FileNotFoundError(f"Dataset for {symbol} not found. Please run the collector first.")
