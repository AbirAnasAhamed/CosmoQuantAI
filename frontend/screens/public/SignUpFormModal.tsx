...
const SignUpFormModal: React.FC<SignUpFormModalProps> = ({ onClose, onRegister }) => {
    ...
    const InputField = ({ id, type, placeholder, value, onChange, icon }: any) => (
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Left Side - Creative Panel (Visible on Desktop) */}
                ...
                <div className="w-full md:w-7/12 p-8 md:p-12 bg-white dark:bg-brand-darkest relative">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <Button type="submit" variant="primary" className="w-full py-3.5 rounded-xl text-base font-bold shadow-lg shadow-brand-primary/25 hover:shadow-brand-primary/40 transform hover:-translate-y-0.5 transition-all">
                            Start Quantifying
                        </Button>
                    </form>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <button onClick={onRegister} className="flex items-center justify-center py-2.5 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
