...
const CATEGORIES: Category[] = [
    ...
    },
    {
        ...
        features: [
            ...
            {
                id: 'crypto_funding_rate_imbalance_proxy',
                name: 'Funding Rate Imbalance Proxy',
                desc: 'Inferred pressure from futures vs spot premium.',
                icon: DollarSign,
                color: 'text-rose-400',
                bg: 'bg-rose-500/10',
                ...
                status: 'live',
                impact: 'high',
                tooltip: 'Derived from price basis when direct API is unavailable.',
            },
            {
                id: 'stablecoin_depeg_micro_pressure',
                name: 'Stablecoin Micro-Depeg Pressure',
                desc: 'Priced-in panic when USDT/USDC deviates by fractions of a cent.',
                icon: AlertTriangle,
                color: 'text-amber-400',
                bg: 'bg-amber-500/10',
                border: 'border-amber-500/30',
                status: 'live',
                impact: 'medium',
                tooltip: 'Watches stablecoin pairs for micro-liquidity drains.',
            },
        ],
    },
    {
