...
const BotLabModal: React.FC<BotLabModalProps> = ({ onClose }) => {
    return (
        <div 
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="botlab-modal-title"
        >
            <div 
            ...
            >
                <header className="flex justify-between items-center p-4 border-b border-brand-border-light dark:border-brand-border-dark flex-shrink-0">
                    <h2 id="botlab-modal-title" className="text-xl font-bold text-slate-900 dark:text-white">Bot Lab</h2>
